...
import UserLocation from '../extra/GoogleMap';
...
const Cart = () => {
    ...
    const { firmName,firmId } = useParams();
    ...
    const addOrder = async () => {
        try {
            const response = await fetch(`${API_URL}/order/add/${firmId}`, {
                method: "POST",
                headers: {
                        ...
                        <div key={item.productId._id} className="cart-item">
                            <div className="cart-item-inner">
                                ...
                                <div className="cart-item-info">
                                    ...
                                    <p className="cart-item-price">Firm: {item.productId.firmName}</p>
